document.addEventListener('DOMContentLoaded', function() {
    var submitlinkBtn = document.getElementById('submitsearchBtn');
    var form = document.getElementById('searchForm');
    var cancelBtn = document.getElementById('cancelBtn_search');
    ...
    submitsearchBtn.addEventListener('click', function(e) {
        ...
        xhr.open('POST','app/server/system/search.php', true);
