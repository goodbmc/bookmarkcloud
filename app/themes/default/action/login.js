document.addEventListener('DOMContentLoaded', function() {
    var submitlinkBtn = document.getElementById('submitloginBtn');
    var form = document.getElementById('loginForm');
    var cancelBtn = document.getElementById('cancelBtn_login');
    ...
    submitlinkBtn.addEventListener('click', function(e) {
        ...
        xhr.open('POST','app/server/system/login.php', true);
